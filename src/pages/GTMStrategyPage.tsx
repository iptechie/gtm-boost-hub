  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 min-h-screen ml-64">
        <Header title="GTM Strategy">
          <Button 
            className="btn-gradient flex items-center gap-2"
            onClick={() => toast.info("Create strategy feature coming soon")}
          >
        ...
        <div className="p-6 page-transition">
          <div className="mb-6">
            ...
            <p className="text-slate-500">
              Define your target market, value proposition, pricing strategy, and more.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="glass-card p-6 hover-scale">
              ...
              <Button variant="outline" className="w-full" onClick={() => toast.info("Feature in development")}>
                Start Analysis
              </Button>
            </div>
            
            <div className="glass-card p-6 hover-scale">
              <h3 className="font-medium text-slate-700 mb-2">Positioning Strategy</h3>
              <p className="text-sm text-slate-500 mb-4">
          ...
          <div className="glass-card p-6 mb-8">
            <h3 className="font-medium text-slate-700 mb-4">GTM Framework Templates</h3>
